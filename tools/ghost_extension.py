...
TOOL = "GHOST-OIDCAuditor"
VERSION = "3.0-PRO"
PROFILE = "OAuth2 and OIDC authentication flow security auditor"
RULES = [('OAUTH-IMPLICIT', 'response_type=token|response_type=id_token\\s+token'), ('OAUTH-REDIRECT', 'redirect_uri=http://|redirect_uri=\\*'), ('OAUTH-SECRET', 'client_secret\\s*[:=]\\s*\\"?[A-Za-z0-9_\\-\\./]{8,}')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-OIDCAuditor v3.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
