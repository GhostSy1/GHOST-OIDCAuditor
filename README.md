...
OAuth2 and OIDC Authentication Flow Security Auditor. Developed by Abdulaziz (Ghost-SY1).

## Overview

`GHOST-OIDCAuditor` is a specialized security analysis tool designed to inspect configuration exports, logs, or evidence files supplied by the operator. It computes SHA-256 integrity hashes for all inspected files, identifies observable indicators, and generates structured reports without executing untrusted code or making network requests.
